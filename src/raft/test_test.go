...
func TestReElection(t *testing.T) {
	...
	fmt.Printf("Test: a new one should be elected after leader disconnect\n")
	...
	fmt.Printf("Test: old leader reconnect shouldn't disturb the new leader\n")
	cfg.connect(leader1)
	...
	fmt.Printf("Test: elect a new leader after quorum arises\n")
	cfg.connect((leader2 + 1) % servers)
	cfg.checkOneLeader()

	// re-join of last node shouldn't prevent leader from existing.

	fmt.Printf("Test: re-join shoudln't prenvet leader from existing\n")
	cfg.connect(leader2)
	cfg.checkOneLeader()
